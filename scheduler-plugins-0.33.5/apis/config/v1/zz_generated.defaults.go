...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&VaclabSchedulingArgs{}, func(obj interface{}) { SetObjectDefaults_VaclabSchedulingArgs(obj.(*VaclabSchedulingArgs)) })
	return nil
}
...
func SetObjectDefaults_VaclabSchedulingArgs(in *VaclabSchedulingArgs) {
	SetDefaults_VaclabSchedulingArgs(in)
}
