...
/*func (v *VaclabSchedulingArgs) DeepCopyObject() runtime.Object {
	panic("unimplemented")
}*/

// GetObjectKind implements [runtime.Object].
// Subtle: this method shadows the method (TypeMeta).GetObjectKind of VaclabSchedulingArgs.TypeMeta.
/*func (v *VaclabSchedulingArgs) GetObjectKind() schema.ObjectKind {
	panic("unimplemented")
}*/
