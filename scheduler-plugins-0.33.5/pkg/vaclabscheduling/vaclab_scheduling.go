...
func (v *VaclabScheduling) Filter(ctx context.Context,
...
func (v *VaclabScheduling) Score(ctx context.Context,
	cycleState *framework.CycleState,
	pod *v1.Pod,
...
// Reserve reserves bandwidth for the pod on the selected node
...
// Unreserve releases reserved bandwidth if pod binding fails
