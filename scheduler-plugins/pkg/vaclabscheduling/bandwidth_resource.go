...
import (
	...
	networkingv1 "sigs.k8s.io/scheduler-plugins/apis/networking/v1"
)
...
const (
	...
	DefaultEgressBandwidthAnnotation  = "ovn.kubernetes.io/egress_rate"
	DefaultIngressBandwidthAnnotation = "ovn.kubernetes.io/ingress_rate"
