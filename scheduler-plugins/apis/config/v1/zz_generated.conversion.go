...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VaclabSchedulingArgs)(nil), (*config.VaclabSchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_VaclabSchedulingArgs_To_config_VaclabSchedulingArgs(a.(*VaclabSchedulingArgs), b.(*config.VaclabSchedulingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.VaclabSchedulingArgs)(nil), (*VaclabSchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_VaclabSchedulingArgs_To_v1_VaclabSchedulingArgs(a.(*config.VaclabSchedulingArgs), b.(*VaclabSchedulingArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_VaclabSchedulingArgs_To_config_VaclabSchedulingArgs(in *VaclabSchedulingArgs, out *config.VaclabSchedulingArgs, s conversion.Scope) error {
	out.EgressBandwidthAnnotation = in.EgressBandwidthAnnotation
	out.IngressBandwidthAnnotation = in.IngressBandwidthAnnotation
	out.DefaultEgressMbps = in.DefaultEgressMbps
	out.DefaultIngressMbps = in.DefaultIngressMbps
	return nil
}

// Convert_v1_VaclabSchedulingArgs_To_config_VaclabSchedulingArgs is an autogenerated conversion function.
func Convert_v1_VaclabSchedulingArgs_To_config_VaclabSchedulingArgs(in *VaclabSchedulingArgs, out *config.VaclabSchedulingArgs, s conversion.Scope) error {
	return autoConvert_v1_VaclabSchedulingArgs_To_config_VaclabSchedulingArgs(in, out, s)
}

func autoConvert_config_VaclabSchedulingArgs_To_v1_VaclabSchedulingArgs(in *config.VaclabSchedulingArgs, out *VaclabSchedulingArgs, s conversion.Scope) error {
	out.EgressBandwidthAnnotation = in.EgressBandwidthAnnotation
	out.IngressBandwidthAnnotation = in.IngressBandwidthAnnotation
	out.DefaultEgressMbps = in.DefaultEgressMbps
	out.DefaultIngressMbps = in.DefaultIngressMbps
...
// Convert_config_VaclabSchedulingArgs_To_v1_VaclabSchedulingArgs is an autogenerated conversion function.
func Convert_config_VaclabSchedulingArgs_To_v1_VaclabSchedulingArgs(in *config.VaclabSchedulingArgs, out *VaclabSchedulingArgs, s conversion.Scope) error {
	return autoConvert_config_VaclabSchedulingArgs_To_v1_VaclabSchedulingArgs(in, out, s)
}
